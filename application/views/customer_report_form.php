  ...
  <!-- Main content -->
    <section class="content">      
     <div class="box box-default">        
      ...
      <div class="box-body">
       <div class="row"> 
        <form method="post" action="<?php echo base_url().'admin/CustomerexcelReport'; ?>">
         <div class="col-md-12">       
  ...
  function getorder()
  {
   $.ajax({
        ...
        success: function(data)
          ...
          for(var i=0;i<response.results.length;i++)
          {
             option+='<tr><td>'+ (i+1) +'</td><td>'+ response.results[i]['branch_name'] +'</td><td>'+ response.results[i]['customer_name'] +'</td><td>'+ response.results[i]['customer_mobile'] +'</td><td>'+ response.results[i]['customer_email'] +'</td><td>'+ response.results[i]['payment_amount'] +'</td><td>'+ response.results[i]['payment_mode'] +'</td></tr>'
          }

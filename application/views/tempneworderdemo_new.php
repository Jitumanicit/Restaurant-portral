                        ...
                        <table>				     
					     <!--<tbody>-->				   
					      <?php $i=0; foreach($soup as $val){   ?>					  
						   ...
						   <span>
						     <tr id="soup<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="ssugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td></tr>
						   </span>
					      <?php $i++; } ?>
					     <!--</tbody>-->
				        </table>				   
                       ...
                       <div class="panel-body">
                        <table>				     
					     <!--<tbody>-->					 
						  ...
						  <span>
						    <tr id="roti<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="rsugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td></tr>
						  </span>
					      <?php $i++; } ?>					   
					     <!--</tbody>-->
				        </table>				  
				        ...
				        <table>				     
					     <!--<tbody>-->
					      <?php $i=0; foreach($beer as $val){  ?>
						   ...
						   <span>
						    <tr id="beer<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="besugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td></tr>
						   </span>
					      <?php $i++; } ?>					   
				         <!--</tbody>-->  
				        </table>	
                         ...
                         <table>				     
					      <!--<tbody>-->				 
					       <?php $i=0; foreach($parata as $val){  ?>
							...
							<span>
							 <tr id="parata<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="psugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td></tr>
							</span>
					       <?php $i++; } ?>					   
					       <!--</tbody>-->
				          </table>				   
                       ...
                       <div class="panel-body">
                        <table>				     
					     <tbody>
						  ...
						  <span>
						   <tr id="biriyani<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="bsugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td></tr>
						  </span>
					      <?php $i++; } ?>					   
					    </tbody>
				       </table>				   
				     ...
				     <div id="collapseeight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingeight">
				      ...
				      <table>				     
					    ...
					    <?php $i=0; foreach($vodka as $val){ ?>
						 ...
						 <span>
						  <tr id="vodka<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="vsugestion<?php echo $i; ?>" name="sugestion[]" class="form-control input-sm sug"></td></tr>
						 </span>
					    <?php $i++; } ?>					   
					    </tbody>
				       </table>	
                      ...
                      <div class="panel-body">				    
				       <table>				     
					    <tbody>
						 ...
						 <span>
						  <tr id="chincken<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="cgsugestion<?php echo $i; ?>" name="sugestion[]" class="form-control input-sm sug"></td></tr>
						 </span>
					     <?php $i++; } ?>					   
					    </tbody>
				       </table>
				        ...
				        <table>				     
					     ...
					     <span>
					      <tr>
					       ...
					       <td><input type="hidden" id="cdsugestion<?php echo $i; ?>" name="sugestion[]" class="input-sm sug"></td>
						  </tr>						  
					     </span> 
					     <?php $i++; } ?>					   
					    </tbody>
				       ...
				       <table>				     
					    <tbody>
					     <?php $i=0; foreach($whisky as $val){  ?>
						  ...
						  <span>
						   <tr id="whisky<?php echo $i; ?>" style="display: none;"><td colspan="3"><input type="text" id="wsugestion<?php echo $i; ?>" name="sugestion[]" class="form-control input-sm sug"></td></tr>
					      </span>
					     <?php $i++; } ?>					   
					    </tbody>
				       </table>	
				   ...
				   <div class="col-md-12" align="center">
				    <span>
					 <a href="#1a" data-toggle="tab" class="btn btn-primary btn-sm">Back</a>
			       	 <a href="#3a" data-toggle="tab" class="btn btn-success btn-sm" onclick="saveMenus()">Generate Order</a>
					 <!--<input type="submit" name="submit" value="Generate Order" class="btn btn-success btn-sm" onclick="saveMenus()">--> 
			 ...
			 <div class="tab-pane" id="3a">
              <div class="col-md-12"><br></div>
		       ...
		       <div class="col-md-12" align="center">		    
			     ...
			     <a href="#4a" data-toggle="tab" class="btn btn-success btn-sm" onclick="saveform()">Order Confirm</a>
   ...
   <script>
	...
	{ 
	   window.setTimeout(function(){ getorder(); gettemporder(); gettable(); }, 1000);
	   window.setInterval(function(){ getorder(); gettemporder(); }, 30000);
    }); 
	 ...
	 $.ajax({
		     ...
		     {				
			  ...
			  { 
			   ...
			   //<th>Table No</th>
			   options+='<div class="panel panel-primary"><div class="panel-heading">Order Table No  ( '+ response.results[j]['table_number'] +' )</div><div class="panel-body"><div class="table-responsive"><table class="table"><thead><tr><th>Action</th><th>Menu Name</th><th>Qty</th><th>Note</th></tr></thead><tbody id="chafmenu_id'+ids+'"></tbody></table><div class="col-md-12"><p align="center"><a href="#3a" data-toggle="tab" class="btn btn-primary btn-sm">Back</a> | <a class="btn btn-success btn-sm" onclick="billrequest(1,'+ response.results[j]['orderid'] +')">Bill Request</a> | <a href="#2a" data-toggle="tab" class="btn btn-primary btn-sm" onclick="getprevious('+ response.results[j]['orderid'] +')">Add Extra Order</a></p></div></div></div></div>'
			   $.ajax({
                       type:'post', 
			           dataType:"json",
		               ...
		               {						  					   
				        ...
				        { 
						 ...
						 //<td>'+ response.result[i]['table_number'] +'</td>
				         option+='<tr><td>'+ action +'</td><td>'+ response.result[i]['menu_name'] +'</td><td>'+ response.result[i]['qty'] +'</td><td>'+ response.result[i]['suggestion'] +'</td></tr>'
				        }							
                         ...
                         //$('#chafmenu_id'+j).html(option);
						 //alert(response.result[0]['orderid']);
						}
                      });
			  }
	   ...
	   $.ajax({
		       ...
		       {				
				 ...
				 { 
				   ...
				   if(temp==0)
				   {  
			        temp = response.results[i]['orderid'];
					option+='<tr><td colspan="5">btn</td></tr>'
				   }
				   else if(temp != response.results[i]['orderid'])
				   {
				    option+='<tr><td colspan="5">btn</td></tr>'
				   }
	 ...
	 { 
	  $.ajax({
		      ...
		      {				
                ...
                for(var i=0;i<response.results.length;i++)
				{
				 option ='<a class="label label-info">Proceed</a>'; 
				}
			  } 
	        });
	 }	 

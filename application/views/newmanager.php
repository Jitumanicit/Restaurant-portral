           ...
           <div class="col-md-12"> 		   
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6">
				...
				<input type="text" name="manager_name" id="manager_name" class="form-control" style='text-transform:capitalize'>
			  </div>			  
            </div>
			...
			<div class="form-group">			   
			  <div class="col-md-6">
				...
				<input type="text" name="manager_city" id="manager_city" class="form-control" style='text-transform:capitalize'>
			  </div> 
			  <div class="col-md-6">
			    <label>Manager Pincode</label>               
				<input type="text" name="manager_pincode" id="manager_pincode" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6">
			  </div>			  
            </div>
			...
			<div class="form-group">
			  <div class="col-md-6">
				...
				<input type="text" name="manager_address" id="manager_address" class="form-control" style='text-transform:capitalize'>
			  </div>
			  <div class="col-md-6">
			    <label>Manager Mobile</label>               
				<input type="text" name="manager_mobile" id="manager_mobile" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10">
			  </div>			  
            </div>
			...
			<div class="form-group">			  
			  <div class="col-md-6">
				...
				<input type="text" name="manager_email" id="manager_email" class="form-control">
			  </div>
			  <div class="col-md-6">

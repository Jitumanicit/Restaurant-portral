           ...
           <div class="col-md-12"> 		   
			<div class="form-group">
			  <div class="col-md-6">
				...
				<input type="text" name="chef_name" id="chef_name" class="form-control" value="<?php echo $result[0]['chef_name']; ?>" style='text-transform:capitalize'>
			    <input type="hidden" name="editid" id="editid" class="form-control" value="<?php echo $result[0]['id']; ?>">
			    <input type="hidden" name="chef_code" id="chef_code" class="form-control" value="<?php echo $result[0]['chef_code']; ?>">
			  </div>
			  <div class="col-md-6">
			    <label>Chef City</label>               
				<input type="text" name="chef_city" id="chef_city" class="form-control" value="<?php echo $result[0]['chef_city']; ?>" style='text-transform:capitalize'>
			  </div> 
            </div>
			...
			<div class="form-group">			   
			 <div class="col-md-6">
			  ...
			  <input type="text" name="chef_pincode" id="chef_pincode" class="form-control" value="<?php echo $result[0]['chef_pincode'];?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6">
			 </div>
			 <div class="col-md-6">
              <label>Chef Address</label>               
			  <input type="text" name="chef_address" id="chef_address" class="form-control" value="<?php echo $result[0]['chef_address'];?>" style='text-transform:capitalize'>
			 </div>
            </div>
			...
			<div class="form-group">			   
			  <div class="col-md-6">
			   ...
			   <input type="text" name="chef_mobile" id="chef_mobile" class="form-control" value="<?php echo $result[0]['chef_mobile'];?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10">
			  </div>
			  <div class="col-md-6">
               <label>Chef Email</label>               
			   <input type="text" name="chef_email" id="chef_email" class="form-control" value="<?php echo $result[0]['chef_email'];?>">
			  </div>
            </div>

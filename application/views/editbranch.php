           ...
           <div class="col-md-12"> 		   
			<div class="form-group">
			  <div class="col-md-6">
				...
				<input type="text" name="branch_name" id="branch_name" class="form-control" value="<?php echo $result[0]['branch_name'];?>" style='text-transform:capitalize'>
			    <input type="hidden" name="editid" id="editid" class="form-control" value="<?php echo $result[0]['id'];?>">			       
			  </div>
			  <div class="col-md-6">
			    <label>Branch City</label>               
				<input type="text" name="branch_city" id="branch_city" class="form-control" value="<?php echo $result[0]['branch_city'];?>" style='text-transform:capitalize'>
			  </div> 
            </div>
			<div class="form-group">			   
			   <div class="col-md-6">
			     <label>Branch Pincode</label>               
				 <input type="text" name="branch_pincode" id="branch_pincode" class="form-control" value="<?php echo $result[0]['branch_pincode'];?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6">
			   </div>
               <div class="col-md-6">
			     <label>Branch State</label>               
                  <select name="state_id" id="state_id" class="form-control">
			         ...
			         <option value="<?php echo $val['id']; ?>" <?php if($result[0]['state_id']==$val['id']){ echo 'selected="selected"'; }?> ><?php echo $val['state_name']; ?></option>
			         <?php } ?>
			     </select>
			   </div>
            </div>
            ...
            <div class="form-group">
			  <div class="col-md-6">
			   ...
			   <input type="text" name="branch_address" id="branch_address" class="form-control" value="<?php echo $result[0]['branch_address'];?>" style='text-transform:capitalize'>
			  </div>

    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Sale By Category</li>
      </ol>
    </section>
  <!-- Main content -->
    <section class="content">      
     <div class="box box-default">        
      ...
      <div class="box-body">
       <div class="row"> 
        <form method="post" action="<?php echo base_url().'admin/consolidateexcelReport'; ?>">
         <div class="col-md-12">       
  ...
  function getorder()
  {
   $.ajax({
        ...
        success: function(data)
          ...
          for(var i=0;i<response.results.length;i++)
          {
             option+='<tr><td>'+ (i+1) +'</td><td>'+ response.results[i]['branch_name'] +'</td><td>'+ response.results[i]['category_name'] +'</td><td>'+ response.results[i]['qty'] +'</td><td>'+ response.results[i]['created_at'] +'</td></tr>'
          }

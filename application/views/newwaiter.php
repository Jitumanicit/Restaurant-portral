           ...
           <div class="col-md-12"> 		   
			<div class="form-group">
			  <div class="col-md-6">
				...
				<input type="text" name="waiter_name" id="waiter_name" class="form-control" style='text-transform:capitalize'>
			  </div>
			  <div class="col-md-6">
			    <label>Waiter City</label>               
				<input type="text" name="waiter_city" id="waiter_city" class="form-control" style='text-transform:capitalize'>
			  </div> 
            </div>
			<div class="form-group">			   
			 <div class="col-md-6">
			  <label>Waiter Pincode</label>               
			  <input type="text" name="waiter_pincode" id="waiter_pincode" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6"> 
			 </div>
			 <div class="col-md-6">
              <label>Waiter Address</label>               
			  <input type="text" name="waiter_address" id="waiter_address" class="form-control" style='text-transform:capitalize'>
			 </div>
            </div>
			...
			<div class="form-group">			   
			 <div class="col-md-6">
			  ...
			  <input type="text" name="waiter_mobile" id="waiter_mobile" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10">
			 </div>
			 <div class="col-md-6">
              <label>Waiter Email</label>               
			  <input type="text" name="waiter_email" id="waiter_email" class="form-control">
			 </div>
            </div>

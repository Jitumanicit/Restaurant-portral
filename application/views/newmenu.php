           ...
           <div class="col-md-12"> 		   
			<div class="form-group">
			  ...
			  <div class="col-md-6">
				...
				<input type="text" name="menu_name" id="menu_name" class="form-control" style='text-transform:capitalize'>
			  </div>			  
            </div>	
			...
			<div class="form-group">
			  <div class="col-md-6">
				...
				<input type="text" name="menu_price" id="menu_price" class="form-control">
			  </div>
			  <div class="col-md-6">
			    <label>Time</label>               
				<input type="text" name="menu_time" id="menu_time" class="form-control">
			  </div>
			  <div class="col-md-6" style="visibility: hidden;">
			    <label>Menu Availability</label>               
				<input type="text" value="1" name="menu_aval" id="menu_aval" class="form-control">
			  </div>
			</div>

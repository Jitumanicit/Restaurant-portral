		  ...
		  <form method="post" name="bill">
		   <div class="form-group"> 
			...
			<div class="col-md-6">
			  ...
			  <input type="text" name="coupan_code" id="coupan_code" class="form-control"> 
			</div>
			<div class="col-md-6">
			  <label>Discount</label>
			  <input type="text" name="discount" id="discount" class="form-control" onkeyup="diduction(this.value);"> 
			</div>			
			<div class="col-md-6">
   ...
   <!-- SELECT tbl_menu.menu_name,tbl_order.menu_id,count(tbl_order.menu_id) FROM tbl_order,tbl_menu where tbl_order.menu_id=tbl_menu.id group by menu_id -->   